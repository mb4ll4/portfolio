 ...
 */
        ...
        this.targetV = new THREE.Vector3( 0, 0, 0 );
...
/*         this.hemiLight = new THREE.HemisphereLight( 0xffffff, 1 );
        this.scene.add(this.hemiLight) */

        this.ambiLight = new THREE.AmbientLight( 0xffffff, 2.5 );
        this.scene.add(this.ambiLight)

        this.pointLight = new THREE.PointLight( 0xffffff, 15, 100 );
   ...
   /*      this.dirlight = new THREE.DirectionalLight( 0xffffff, 10 );
        ...
        this.spotLight.shadow.camera.far = 0.5; 
        ...
        this.targetA = new THREE.Group();
        this.targetA.position.set( 0, 0, 0 );
        this.scene.add(this.targetA);
        ...
        this.target.add(this.lap);
        this.target.add(this.desk);
        this.target.add(this.tablet);

        this.targetA.add(this.target)
        this.targetV.add(this.targetA)
    ...
    setupModels(){
        ...
        this.penloader.load('./assets/models/pen_test.glb',( gltf ) => {
        ...
        this.headphonesloader.load('./assets/models/headphones_test.glb',( gltf ) => {
        ...
        this.phoneloader.load('./assets/models/phone_test.glb',( gltf ) => {
        ...
        this.keyboardloader.load('./assets/models/keyboard_test.glb',( gltf ) => {
...
/*         this.mouseloader = new GLTFLoader(manager);
        this.mouseloader.load('./assets/models/mouse.glb',( gltf ) => {
        ...
        this.tabletloader = new GLTFLoader(manager);
        this.tabletloader.load('./assets/models/tablet_test.glb',( gltf ) => {
            this.tablet.add( gltf.scene );
                gltf.scene.traverse( o => {
                    if( o.isMesh ){
                        o.castShadow = true,
                        o.receiveShadow = true;
...
/*         this.camloader = new GLTFLoader(manager);
        this.camloader.load('./assets/models/camera.glb',( gltf ) => {
        ...
        this.laploader = new GLTFLoader(manager);
        this.laploader.load('./assets/models/laptop_test.glb',( gltf ) => {
            this.lap.add( gltf.scene );
                gltf.scene.traverse( o => {
                    if( o.isMesh ){
                        o.castShadow = true,
                        o.receiveShadow = true;
        ...
        this.deskloader = new GLTFLoader(manager);
        this.deskloader.load('./assets/models/desktop_test.glb',( gltf ) => {
            this.desk.add( gltf.scene );
                gltf.scene.traverse( o => {
                    if( o.isMesh ){
                        o.castShadow = true,
                        o.receiveShadow = true;
    ...
    /* setupCube() {
        ...
        this.cube.position.set( -5, -5.6, -5 );
        ...
        this.cube.position.set( -8, -5.6, 5 );
        this.cube.castShadow = true;
        this.cube.receiveShadow = true;
        this.scene.add(this.cube);
        ...
        this.cube.position.set( 5, -5.6, 12 );
        this.cube.castShadow = true;
        this.cube.receiveShadow = true;
        this.scene.add(this.cube);
    } */
    ...
    setupGround() {
        ...
        this.sground.position.set( 0, -6.1, 0 );
 ...
 /*        this.fground = new THREE.Mesh(
        ...
        this.fground.receiveShadow = true;
    ...
    setupGsap() {
        ...
        gsap.fromTo(this.tablet.position, 8.5,{ 	
        ...
        gsap.fromTo(this.lap.position, 8.5,{ 	
        ...
        gsap.fromTo(this.desk.position, 8.5,{ 	
...
/*         gsap.fromTo(this.cube.position, 9.5,{ 	
        ...
        let camtl = new gsap.timeline({
           ...
           /*  toggleActions: "restart pause resume pause", */
            ...
            camtl.to(this.camera.position, {x: 0, y: 15, z: 90, duration: 4}, "slide-b", delay)
            /* camtl.to(this.targetA.position, {x: 0, y: 0, z: 0, duration: 4}, "slide-b", delay) */
            camtl.to(this.targetA.rotation, {x: 0, y: 4, z: 0, duration: 4}, "slide-b", delay)
            /* camtl.to(this.target.rotation, {x: 1, y: 0.1, duration: 4}, "slide-b") */
            /* camtl.to(this.scene.rotation, {x: 1, y: -2, duration: 6}, "slide-b") */
            /* camtl.to(this.camera.position, {x: 0, y: -40, z: 70, duration: 4}, "slide-b", delay) */
            ...
            /* camtl.to(this.camera.rotation, {x: 0, y: 0.5, z: 0, duration: 4}, "slide-b")   */

            delay += slideDuration;

            // Slide 3

            camtl.to(this.camera.position, {x: 0, y: 30, z: 70, duration: 4}, "slide-c", delay)
            camtl.to(this.targetA.rotation, {x: 0, y: 8, z: 0, duration: 4}, "slide-c", delay)
            /* camtl.to(this.target.rotation, {y: -4, duration: 4}, "slide-c") */
            /* camtl.to(this.camera.position, {x: 0, y: -80, z: 70, duration: 4}, "slide-c", delay) */            
            /* camtl.to(this.camera.rotation, {x: 0, y: -0.3, z: -0.5, duration: 6}, "slide-c") */
            /* camtl.to(this.camera.rotation, { y: 0.2, duration: 4}, "slide-c") */
            /* camtl.to(this.camera.rotation, {x: 0, y: 1, z: 0, duration: 4}, "slide-b")  */

            delay += slideDuration;

            // Slide 4

            camtl.to(this.camera.position, {x: -50, y: 60, z: -20, duration: 4}, "slide-d", delay)
            camtl.to(this.targetA.rotation, {x: 0, y: 12, z: 0, duration: 4}, "slide-d", delay)
            /* camtl.to(this.target.rotation, {x: 30, y: 30, duration: 6}, "slide-d", delay) */
            /* camtl.to(this.camera.position, {x: 0, y: -120, z: 70, duration: 4}, "slide-d", delay) */
            /* camtl.to(scene.rotation, {z: .035, y: -3.15, duration: 4}, "slide4") */
            /* camtl.to(this.camera.rotation, {x: 0, y: 1.5, z: 0, duration: 4}, "slide-b")  */
    ...
    setupNav() {
        ...
        function animateTopNav() {
            ...
            var btns = topNav.getElementsByClassName("topnav__link");
            for (var i = 0; i < btns.length; i++) {
              btns[i].addEventListener("click", function() {
              var current = document.getElementsByClassName("topnav__linkactive");
              current[0].className = current[0].className.replace(" topnav__linkactive", "");
              this.className += " topnav__linkactive";
              });
            }
        }
    ...
    mouseMove(e) {
        ...
        gsap.to(this.target.rotation, {
          y: gsap.utils.mapRange(0, window.innerWidth, 0.25, -0.25, this.mouse.x),
          x: gsap.utils.mapRange(0, window.innerHeight, 0.25, -0.25, this.mouse.y)
        });    
    }
